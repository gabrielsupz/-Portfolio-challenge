        ...
        <div>
          <div className="project projectOne">
            <div className="nameProject">
              ...
              <a
                href="https://github.com/SuptitzGabriel/-Portfolio-challenge"
                target="blank"
              >
                -Portfolio-challenge
              </a>
            ...
            <p>
              Desafio da rockeseat,realizado com intuito de aprender mais sobre
              html e css,feito em react para treino.
            </p>
            <div>
              <div className="infoProject">
                <div className="infoGitHub">
                  <div>
                    <img
                      src="../public/assets/star-project.svg"
                      alt="Ícon Star"
                    />
                    <p>000</p>
                  </div>
          ...
          <div className="project projectTwo">
            ...
            <p>
              Projeto realizado na NLW Return da Rocketseat com intuito de
              aprender o básico de html e css, criando um site simples.
            </p>
            <div>
              <div className="infoProject">
                <div className="infoGitHub">
